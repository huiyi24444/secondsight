                  ...
                  child: OutlinedButton(
                    onPressed: () async {
                      ...
                      final existingCart = await cartRef
                          .where('productID', isEqualTo: FirebaseFirestore.instance.collection('products').doc(productId))
                          .limit(1)
                          .get();
                      ...
                      if (existingCart.docs.isNotEmpty) {
                        ...
                        await cartRef.add({
                          'productID': FirebaseFirestore.instance.collection('products').doc(productId),
                          'cartQuantity': 1,
                        });
                      }
